...
void ifcclexerLexerInitialize() {
  ...
  auto staticData = std::make_unique<IfccLexerStaticData>(
    std::vector<std::string>{
      ...
      "RETURN", "CONST", "COMMENT", "DIRECTIVE", "WS", "VAR", "OPMULTDIV", 
      "OPADDSUB"
    },
    std::vector<std::string>{
  ...
  static const int32_t serializedATNSegment[] = {
  	...
  	125,0,0,51,12,1,0,0,0,52,53,5,61,0,0,53,14,1,0,0,0,54,55,5,59,0,0,55,
  	16,1,0,0,0,56,57,5,44,0,0,57,18,1,0,0,0,58,59,5,114,0,0,59,60,5,101,0,
